...
class ReplayBuffer:
    """
    Fixed-size replay buffer for off-policy multi-agent reinforcement learning.
    """
...
class MADDPGAgent:
    ...
    def update(self, batch_size=64):
        ...
        with torch.no_grad():
            ...
            flat_target_actions = target_actions.reshape(batch_size, -1)
        ...
        flat_curr_actions = curr_actions.reshape(batch_size, -1)
